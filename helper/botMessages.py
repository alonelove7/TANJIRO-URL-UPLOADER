...
class BotMessage(object):
    common_text = "\n\n<u>If you are facing any problem, so report at @sctbotssupport</u>"
    ...
    start_msg = f"<b>Hi, I am TANJIRO URL_UploaderBot Created by @sctbots and My Developer is @harshahero.</b>\n{help_msg}"
